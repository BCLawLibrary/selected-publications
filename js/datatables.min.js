 ...
 *   https://datatables.net/download/#ju/dt-2.1.8/rg-1.5.1
 *
 * Included libraries:
 *  DataTables 2.1.8, RowGroup 1.5.1
 */
...
!(function (t) {
  ...
  "function" == typeof define && define.amd
    ? define(
        ["jquery", "datatables.net-jqui", "datatables.net-rowgroup"],
        function (e) {
    ...
    ? ((o = require("jquery")),
      (u = function (e, n) {
        n.fn.dataTable || require("datatables.net-jqui")(e, n),
          n.fn.dataTable.RowGroup || require("datatables.net-rowgroup")(e, n);
      }),
      "undefined" == typeof window
        ? (module.exports = function (e, n) {
            return (
              (e = e || window), (n = n || o(e)), u(e, n), t(n, 0, e.document)
            );
          })
        : (u(window, o), (module.exports = t(o, window, window.document))))
